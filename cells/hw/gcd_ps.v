// gcd_ps -- PS7-driven harness for the COMPILED gcd kernel on the
...
module gcd_ps_bridge (
  ...
  bdc_gcd udut (
      .rst       (rst_pl),
      .a_req     (in_req[0]), .a_ack     (a_ack),     .a_data (a_data_reg),
      .b_req     (in_req[1]), .b_ack     (b_ack),     .b_data (b_data_reg),
