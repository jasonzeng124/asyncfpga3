...
def emit(kernel, is_null, top_name):
    ...
    P("                if (bench_busy && st != S_PREP && !clearing && cycles != 32'hFFFFFFFF)")
    P("                    cycles <= cycles + 1;")
    ...
    P("                    S_IDLE: if (clearing) begin")
    P("                        clr_addr <= clr_addr + 6'd1;")
    P("                        if (clr_addr == 6'd63) begin")
    P("                            clearing <= 1'b0;")
    ...
    P("                            end")
    P("                        end")
    P("                    end else if (start_rise && n_runs != 32'b0) begin")
    ...
    P("                        clearing <= 1'b1; clr_addr <= 6'd0; pending_start <= 1'b1;")
    P("                    end")
    P("")
    ...
    P("                    S_WAIT_ACK: if (i_ack_l_s) st <= S_WAIT_RES;")
    P("")
